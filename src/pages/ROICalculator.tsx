...
//   //   // Wait for chart to render and capture it
...
//   //     doc.addImage(imgData, "PNG", 20, 110, 170, 80); // Adjust position and size
//   //   }
...
//               <div ref={chartRef} className="h-64 mt-4">
...
// import { calculateROI, calculateSimpleAnnualROI, calculateCAGR } from "../utils/roiUtils";
import ROIBarChart from "@/components/ROIChart";
import { generatePDF } from "@/components/PDFExporter";
import { Input } from "@/components/ui/input";
import { Slider } from "@/components/ui/slider";
import { Card } from "@/components/ui/card";
import { Label } from "@/components/ui/label";// Adjust paths as needed
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="p-6 space-y-4">
          {isValid ? (
            <>
              <p>
                <strong>Total Gain:</strong> ₹ {gain.toLocaleString()}
              </p>
              <p>
                <strong>ROI:</strong> {roi.toFixed(2)}%
              </p>
              <p>
                <strong>Annual ROI:</strong> {simpleAnnualROI.toFixed(2)}%
              </p>
              <p>
                <strong>CAGR:</strong> {cagr.toFixed(2)}%
              </p>
