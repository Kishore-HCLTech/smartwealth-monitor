...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-[#99CFF0] to-[#C3A1E6] px-4">
      <Card className="w-full max-w-md bg-white shadow-lg rounded-lg p-6">
        <CardHeader className="text-center mb-6">
          <h2 className="text-2xl font-bold text-gray-700">{APP_NAME}</h2>
          <h3 className="text-xl font-semibold text-gray-600">Login</h3>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
